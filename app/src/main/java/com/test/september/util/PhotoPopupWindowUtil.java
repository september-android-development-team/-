...
public class PhotoPopupWindowUtil extends PopupWindow {
    ...
    public PhotoPopupWindowUtil(Context context, View.OnClickListener selectListener, View.OnClickListener captureListener) {
        super(context);
