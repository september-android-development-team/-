...
public class FunGameHeader extends FrameLayout {
    ...
    private void initView(AttributeSet attrs) {
        ...
        //游戏背景色
        maskReLayout.setBackgroundColor(Color.parseColor("#0EB5DD"));
    ...
    private TextView createMaskTextView(String text, int textSize, int gravity) {
        ...
        maskTextView.setTextColor(Color.parseColor("#FFFFFF"));
        maskTextView.setBackgroundColor(Color.parseColor("#0EB5DD"));
