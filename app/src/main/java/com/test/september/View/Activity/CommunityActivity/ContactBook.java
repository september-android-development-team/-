...
import com.test.september.Adapter.ContactsSortAdapter;
import com.test.september.Contact.SortModel;
import com.test.september.Contact.SortToken;
import com.test.september.R;
import com.test.september.View.MyView.SideBar;
import com.test.september.util.Pingying.CharacterParser;
import com.test.september.util.Pingying.PinyinComparator;
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    Cursor phoneCursor = resolver.query(ContactsContract.CommonDataKinds.Phone.CONTENT_URI, new String[]{ContactsContract.CommonDataKinds.Phone.DISPLAY_NAME, ContactsContract.CommonDataKinds.Phone.DATA1, "sort_key"}, null, null, "sort_key COLLATE LOCALIZED asc");
                    ...
                    Log.d("PHONES_NUMBER_INDEX",String.valueOf(PHONES_NUMBER_INDEX));
                    Log.d("PHONES_NAME_INDEX",String.valueOf(PHONES_DISPLAY_NAME_INDEX));
                    Log.d("SORT_KEY_INDEX",String.valueOf(SORT_KEY_INDEX));
