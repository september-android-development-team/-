package com.test.september.View.MyView.RecycleRefresh;
...
abstract class FunGameView extends View {
    ...
    public FunGameView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        lModelColor = typedArray.getColor(R.styleable.FunGame_left_model_color, Color.parseColor("#FF8C00"));
        mModelColor = typedArray.getColor(R.styleable.FunGame_middle_model_color, Color.parseColor("#FF5858"));
        rModelColor = typedArray.getColor(R.styleable.FunGame_right_model_color, Color.parseColor("#FFFFFF"));
        typedArray.recycle();
    ...
    protected void initBaseTools() {
        ...
        //文字颜色
        textPaint.setColor(Color.parseColor("#F1384F"));
    ...
    private void drawBoundary(Canvas canvas) {
        //
        mPaint.setColor(Color.parseColor("#C52B2B"));
